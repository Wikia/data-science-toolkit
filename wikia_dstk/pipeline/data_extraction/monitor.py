...
while True:
    ...
    if not inqueue:
        if not numinstances and spawned_since_empty:
            Popen('/home/ubuntu/venv/bin/python -m wikia_dstk.autoscale.wiki_data_extraction_monitor', shell=True)
            spawned_since_empty = False
